...
public class ValidadorFrontend extends JFrame implements ActionListener, FrontendInterface {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ValidadorFrontend frame = new ValidadorFrontend();
...
class StripedRowTableCellRenderer extends DefaultTableCellRenderer {
    ...
    private static final long serialVersionUID = 7867577987134055340L;

    private static final Color STRIPE = new Color(0.929f, 0.920f, 0.920f);
...
class RowIconTableCellRenderer extends DefaultTableCellRenderer {

    private static final long serialVersionUID = 3913806062762833280L;
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if (value.equals("ok")) {
            lbl.setIcon(new ImageIcon(getClass().getClassLoader().getResource("resources/ok.png")));
        } else {
            lbl.setIcon(new ImageIcon(getClass().getClassLoader().getResource("resources/error.png")));
        }
        return lbl;
    }
}
